...
export function AccountOnboarding({ complete, useApiKey, useAccount, setOnboarding, showLogin, start, cancel, t }:
  ...
  return <SignInDialog account={account} start={start} cancel={cancel} t={t}
