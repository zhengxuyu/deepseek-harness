...
flowchart TD
  ...
  subgraph group_experimental["packages/experimental"]
    ...
    pkg_experimental_agent_team_settlement["experimental-agent-team-settlement"]
    ...
    pkg_experimental_turn_continuation["experimental-turn-continuation"]
  ...
  pkg_experimental_turn_continuation --> pkg_agent
  pkg_experimental_turn_continuation --> pkg_llm
  pkg_experimental_turn_continuation --> pkg_session
  ...
  pkg_command_jev --> pkg_agent
  pkg_command_jev --> pkg_commands
  pkg_command_jev --> pkg_jev
  pkg_command_jev --> pkg_llm
  ...
  pkg_tool_jev --> pkg_jev
  pkg_tool_jev --> pkg_system_prompt
  pkg_tool_jev --> pkg_tools
  pkg_tool_jev --> pkg_util_values
  ...
  pkg_experimental_agent_team --> pkg_fs
  ...
  pkg_experimental_agent_team --> pkg_util_values
  ...
  pkg_experimental_agent_team_settlement --> pkg_agent
  pkg_experimental_agent_team_settlement --> pkg_experimental_agent_team
  pkg_experimental_agent_team_settlement --> pkg_headless
...
| [`client-ui-jev`](../packages/client/ui-jev) | `client` | — |
...
| [`jev`](../packages/jev/jev) | `jev` | [`credentials`](../packages/credentials/credentials), [`launch-environment`](../packages/util/launch-environment), [`llm`](../packages/llm/llm), [`util-values`](../packages/util/values) |
...
| [`experimental-turn-continuation`](../packages/experimental/turn-continuation) | `experimental` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
...
| [`command-jev`](../packages/jev/command-jev) | `jev` | [`agent`](../packages/core/agent), [`commands`](../packages/interaction/commands), [`jev`](../packages/jev/jev), [`llm`](../packages/llm/llm) |
...
| [`tool-jev`](../packages/jev/tool-jev) | `jev` | [`jev`](../packages/jev/jev), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`util-values`](../packages/util/values) |
...
| [`experimental-agent-team`](../packages/experimental/agent-team) | `experimental` | [`agent`](../packages/core/agent), [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol), [`util-values`](../packages/util/values) |
...
| [`experimental-agent-team-settlement`](../packages/experimental/agent-team-settlement) | `experimental` | [`agent`](../packages/core/agent), [`experimental-agent-team`](../packages/experimental/agent-team), [`headless`](../packages/bundle/headless) |
