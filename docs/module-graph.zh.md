...
flowchart TD
  ...
  pkg_experimental_agent_team_settlement --> pkg_invariants
...
| [`experimental-agent-team-settlement`](../packages/experimental/agent-team-settlement) | `experimental` | [`agent`](../packages/core/agent), [`experimental-agent-team`](../packages/experimental/agent-team), [`headless`](../packages/bundle/headless), [`invariants`](../packages/runtime-diagnostics/invariants) |
