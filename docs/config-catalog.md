...
Source: [`packages/jev/command-jev/src/index.ts:58`](../packages/jev/command-jev/src/index.ts)
...
Source: [`packages/experimental/agent-team/src/types.ts:274`](../packages/experimental/agent-team/src/types.ts)
...
Source: [`packages/experimental/agent-team-settlement/src/index.ts:26`](../packages/experimental/agent-team-settlement/src/index.ts)
...
Source: [`packages/jev/jev/src/index.ts:69`](../packages/jev/jev/src/index.ts)
...
Requires: `tools` · `jev` · `systemPrompt`
...
Source: [`packages/jev/tool-jev/src/index.ts:27`](../packages/jev/tool-jev/src/index.ts)
