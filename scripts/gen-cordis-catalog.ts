...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  headlessSettlement: 'interface-typed (HeadlessSettlement) optional value provided by a delegation-tracking plugin — packages/bundle/headless/README.md owns the settlement contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TeamTaskLostCause: 'agent-team.md',
